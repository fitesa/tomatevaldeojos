...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.088349 && value <= -0.034885) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.034885 && value <= 0.018579) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.018579 && value <= 0.072043) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.072043 && value <= 0.125507) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.125507 && value <= 0.178971) {
            style = [ new ol.style.Style({
