...
var style_EvolucionIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.033575 && value <= 0.002740) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.002740 && value <= 0.039056) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.039056 && value <= 0.075371) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.075371 && value <= 0.111686) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.111686 && value <= 0.148002) {
            style = [ new ol.style.Style({
