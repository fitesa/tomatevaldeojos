...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.172210 && value <= 0.263637) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.263637 && value <= 0.355064) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.355064 && value <= 0.446491) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.446491 && value <= 0.537917) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.537917 && value <= 0.629344) {
            style = [ new ol.style.Style({
